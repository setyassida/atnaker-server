...
function Data($file, $x=null, $y=null, $w=0, $h=0, $type='', $link='')
{
...
function DataL($file, $x=null, $y=null, $w=0, $h=0, $type='', $link='')
{
	//Put an image on the page
	if(!isset($this->images[$file]))
	{
	...
	{
		//Put image at 72 dpi
		$w=$info['w']/$this->k/4.167;
		$h=$info['h']/$this->k/4.167;
	}
	elseif($w==0)
		$w=$h*$info['w']/$info['h'];
	elseif($h==0)
