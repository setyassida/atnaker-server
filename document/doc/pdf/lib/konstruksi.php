...
$pdf->AddBig5Font();
$pdf->AddPage();
$pdf->Data('konstruksi_01.dat',0,0);
$pdf->SetFont('Big5','',8);
...
$pdf->Text(24,102,"¹q¸Ü : ".$entryjo->agtelp.", ¶Ç¯u : ".$entryjo->agfax);
...
Barcode::fpdf($pdf, '000000', $bx, $by, 0, 'code39', array('code'=>$code), $bw, $bh);
   ...
   $pdf->SetFont('Big5','',$fs);
$pdf->Text(320,117,$jp->jpgaji/1);
$pdf->Text(519,157,$jp->jpgaji/1);
Barcode::fpdf($pdf, '000000', $bx, $by, 0, 'code39', array('code'=>$code), $bw, $bh);
...
$pdf->Text(310,455,$jp->jpgaji/30);
$pdf->Text(441,518,$jp->jpgaji/30);
$pdf->Text(246,663,$jp->jpgaji/30);
$pdf->Text(386,750,$jp->jpgaji/30);
Barcode::fpdf($pdf, '000000', $bx, $by, 0, 'code39', array('code'=>$code), $bw, $bh);
...
if ($width > 250) {
	...
	$pdf->Text(48,304+count($str)*8,"¹q¸Ü: ".$entryjo->agtelp.", ¶Ç¯u: ".$entryjo->agfax);
} else {
	$pdf->Text(48,304,$entryjo->agalmtkantor);
	$pdf->Text(48,312,"¹q¸Ü: ".$entryjo->agtelp.", ¶Ç¯u: ".$entryjo->agfax);
}
