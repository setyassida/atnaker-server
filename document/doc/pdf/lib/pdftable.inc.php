 ...
 */
#require_once('./include/pdf/lib/fpdf.inc.php');
#require_once('./include/pdf/lib/color.inc.php');
#require_once('./include/pdf/lib/htmlparser.inc.php');

define('FHR',0.58);
define('PDFTABLE_VERSION','1.9');
$PDF_ALIGN  = array('left'=>'L','center'=>'C','right'=>'R','justify'=>'J');
$PDF_VALIGN = array('top'=>'T','middle'=>'M','bottom'=>'B');
class PDFTable extends PDF_Chinese{
...
function Footer(){
	...
	// <tr>
		// <td nowrap>http://chandrawira.wordpress.com</td>
