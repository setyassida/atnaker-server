...
<div class="right_col" role="main" ng-app="InfografikApp">
  ...
  app.config(["$routeProvider", function($routeProvider) {
    $routeProvider.when("/simpati", {templateUrl: window.location.protocol+"//sisnaker.hash.id/assets/template/infografik/simpati.html", controller: "SimpatiController"});
    $routeProvider.when("/tki", {templateUrl: window.location.protocol+"//sisnaker.hash.id/assets/template/infografik/tki.html", controller: "TkiController"});
    $routeProvider.when("/profil",  {templateUrl: window.location.protocol+"//sisnaker.hash.id/assets/template/infografik/indonesia.html", controller: "ProfilController"});
  }]);
